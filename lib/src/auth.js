        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (authType) {
                case constants_1.BASIC_AUTHENTICATION:
                    yield command_1.Command.execute(ocPath, `login ${useCertificateOrSkipTls} -u ${endpoint.parameters.username} -p ${endpoint.parameters.password} ${endpoint.serverUrl}`);
                    break;
                case constants_1.TOKEN_AUTHENTICATION:
                    yield command_1.Command.execute(ocPath, `login ${useCertificateOrSkipTls} --token ${endpoint.parameters.apitoken} ${endpoint.serverUrl}`);
                    break;
